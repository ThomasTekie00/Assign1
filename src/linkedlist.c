...
static void swap(lnode_t *a, lnode_t *b, list_t *list)
{
...
static lnode_t *partition(lnode_t *head, lnode_t *tail, cmp_fn cmpfn, list_t *list)
{
    //
    if (head == NULL || tail == NULL || cmpfn == NULL || list == NULL)
    {
        return NULL;
    }
...
static void sort_recursive(list_t *list, lnode_t *head, lnode_t *tail, cmp_fn cmpfn)
{
    ...
    //
    lnode_t *pivot = partition(head, tail, cmpfn, list);
